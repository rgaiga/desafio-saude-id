...
import { ordersRedisMock } from '../../__tests__/mocks/orders-redis.mock';
...
describe('OrdersRepository', () => {
    ...
    describe('getOrderById', () => {
        it('should return the order with matching "orderId"', async () => {
            ...
            await expect(ordersRepository.getOrderById(userId)).resolves.toEqual(orderStub);
        });
        ...
        it('should throw an error', async () => {
            ...
            await expect(ordersRepository.getOrderById(userId)).rejects.toThrow();
        });
    });
    ...
    describe('createOrder', () => {
        it('should return the created order', async () => {
            ...
            await expect(ordersRepository.createOrder(userId, body)).resolves.toEqual(orderStub);
        });
        ...
        it('should throw an error', async () => {
            ...
            await expect(ordersRepository.createOrder(userId, body)).rejects.toThrow();
        });
    });
    ...
    describe('updateOrder', () => {
        ...
        it('should throw an error', async () => {
            ...
            await expect(ordersRepository.updateOrder(userId, body)).rejects.toThrow();
        });
    });
    ...
    describe('deleteOrder', () => {
        ...
        it('should throw an error', async () => {
            ...
            await expect(ordersRepository.deleteOrder(userId)).rejects.toThrow();
        });
    });
});
