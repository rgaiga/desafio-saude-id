...
import { productsRepositoryMock } from '../__tests__/mocks/products-repository.mock';
...
describe('ProductsService', () => {
    ...
    describe('getAllProducts', () => {
        it('should return all products', async () => {
            await expect(productsService.getAllProducts()).resolves.toEqual([productStub]);
        });
    });
    ...
    describe('getProductById', () => {
        it('should return the product with matching "productId"', async () => {
            ...
            await expect(productsService.getProductById(productId)).resolves.toEqual(productStub);
        });
    });
    ...
    describe('createProduct', () => {
        it('should return the created product', async () => {
            ...
            await expect(productsService.createProduct(body)).resolves.toEqual(productStub);

            expect(clientProxyMock.emit).toHaveBeenCalledWith('product.created', {
    ...
    describe('updateProduct', () => {
        it('should return the updated product', async () => {
            ...
            expect(clientProxyMock.emit).toHaveBeenCalledWith('product.updated', {
                productId: productStub.id,
                body: { ...productStub },
            });
        });
    ...
    describe('deleteProduct', () => {
        it('should return the deleted product', async () => {
            ...
            expect(clientProxyMock.emit).toHaveBeenCalledWith('product.deleted', {
                productId: productStub.id,
            });
        });
    });
